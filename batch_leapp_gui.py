...
class BatchLeappGUI:
    ...
    def _build(self):
        ...
        if logo is not None:
            logo_lbl = tk.Label(header, image=logo, bg=OFF_BLACK, cursor="hand2")
            logo_lbl.pack(side="left", padx=(0, 12))
            logo_lbl.bind("<Button-1>", lambda _e: self._open_leapps())
    ...
    def _open_leapps(self):
        webbrowser.open_new_tab("https://leapps.org")
